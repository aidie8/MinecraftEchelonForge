...
public class Echelon {
    ...
    public ArrayList<EchelonTwitchController.onAuthComplete> onAuthCompletedEvents = new ArrayList<>();
    ...
    public static void getDashboardURL(onDashboardUrl onComplete,String template)
    {
        ...
        TwitchResponses.ClientToken clientToken = EchelonTwitchController.getClientTokenData();
